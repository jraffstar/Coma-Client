...
extends Module {
    ...
    private final Setting<Float> height = this.register( new Setting <> ( "Height" , 5.0f , - 5.0f , 5.0f ));
    private final Setting<Boolean> preferEChests = this.register( new Setting <> ( "Prefer EChests" , true ));

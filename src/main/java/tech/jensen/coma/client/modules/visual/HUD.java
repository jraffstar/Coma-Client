...
import tech.jensen.coma.api.util.font.RainbowText;
...
import tech.jensen.coma.client.modules.client.Colours;
...
extends Module {
    ...
    public final void onRender2D() {
        ...
        if ( this.renderWatermark.getValue ( ) ) {
            this.drawString( this.customWatermark.getValue ( ) ? this.watermarkString.getValue() : "Coma \u00A7fv2.1", 2.0f, this.offsetWatermark.getValue ( ) ? 10.0f : 2.0f, Colours.INSTANCE.getColor());
        }

...
import tech.jensen.coma.api.util.EntityUtil;
...
extends Module {
    ...
    private final Setting<Float> range = this.register( new Setting <> ( "Range" , 9.0f , 1.0f , 15.0f , v -> this.page.getValue ( ) == Page.PLACE ));

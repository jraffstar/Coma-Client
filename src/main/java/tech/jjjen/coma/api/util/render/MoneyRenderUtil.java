package tech.jjjen.coma.api.util.render;
...
import tech.jjjen.coma.api.mixin.mixins.IRenderManager;
...
//moneymod+2 render util pasted

public class MoneyRenderUtil extends net.minecraft.client.renderer.Tessellator {
    ...
    public static MoneyRenderUtil INSTANCE = new MoneyRenderUtil();

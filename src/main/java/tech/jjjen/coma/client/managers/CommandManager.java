...
import tech.jjjen.coma.client.command.commands.*;
...
public class CommandManager implements IListener {
    ...
    public void init() {
        register(new ToggleCommand(), new BindCommand(), new DrawnCommand(), new tech.jjjen.Main.client.command.commands.FriendCommand(), new SaveCommand(), new TutorialCommand());

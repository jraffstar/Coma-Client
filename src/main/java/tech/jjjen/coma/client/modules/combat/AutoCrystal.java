...
import tech.jjjen.coma.api.mixin.mixins.network.AccessorCPacketUseEntity;
import tech.jjjen.coma.api.property.Setting;
import tech.jjjen.coma.api.util.Timer;
import tech.jjjen.coma.api.util.*;
...
import java.awt.*;
import java.util.*;
// NUTGOD Ca Name go brrrrrrrrrr
@ModuleManifest(label = "Autoplace", category = Module.Category.COMBAT, color = 0x880000 /* red */)

...
import tech.jjjen.coma.api.util.ItemUtil;
import tech.jjjen.coma.api.util.MathUtil;
...
public final class HUD extends Module {
    ...
    private final Setting<String> watermarkString = register(new Setting("CustomMark", "StresserLegend.CC v573.5", v -> customWatermark.getValue()));
    ...
    public final void onRender2D() {
        ...
        if (renderWatermark.getValue()) {
            Main.fontManager.drawString(customWatermark.getValue() ? watermarkString.getValue() : "Coma \u00A7fv3.0", 2, offsetWatermark.getValue() ? 10 : 2, Colours.INSTANCE.getColor());
        }
